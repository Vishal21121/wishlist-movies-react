...
const Card = ({ id, backdrop_path, original_title, overview, release_date, popularity, addMovie }) => {
    ...
    return (
        <>
            <div className="w-[300px] my-8 border-2 bg-gradient-to-b from-blue-800 to-[#0B0C10] shadow-xl shadow-gray-400 rounded-lg mx-2 h-[500px]" id={`${id}`}>
                ...
                <div className="relative top-[37px]">
                    ...
                    <button
                        className="add  text-white w-16 bg-blue-500 py-2 rounded-md font-semibold text-xs hover:bg-gradient-to-r to-blue-800 from-[#0B0C10] relative" onClick={addMovie}>Add movie</button>
                </div>
            </div>
        </>
    )
